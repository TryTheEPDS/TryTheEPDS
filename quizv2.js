    ...
    function quiz() {
      ...
      function calculateResults() {
          if (currentScore < 10 || currentScore == 10) {
              $('.quiz .question').html(`<p class="questionText">You scored ${currentScore} out of 30.<br>It is not likely that you have mental health concerns, however, always consult your primary care provider or mental health provider if you have any questions.</p>`)
        } else {
              $('.quiz .question').html(`<p class="questionText">You scored ${currentScore} out of 30.<br>Your score suggests that you may be living with mental health burdens that are affecting your day-to-day life. At your next wellness check up, talk to your primary care physician or current mental health care provider about your results.</p>`)
    }
   }
  }
